...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { first_name: @coach.first_name, last_name: @coach.last_name } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { first_name: @coach.first_name, last_name: @coach.last_name } }
