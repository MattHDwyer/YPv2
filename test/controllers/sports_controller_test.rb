...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { gender: @sport.gender, name: @sport.name, season_id: @sport.season_id } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { gender: @sport.gender, name: @sport.name, season_id: @sport.season_id } }
